...
export const databaseId = "477632e49a074be19448be42e3d2ba0d";
      ...
      <main className={styles.container}>
        <header className={styles.header}>
          <div className={styles.logos}>
            <svg height="80" width="80" xmlns="http://www.w3.org/2000/svg" viewBox="12 0.18999999999999906 487.619 510.941">
              <path
            ...
            <svg width="133px" height="80px" viewBox="0 0 512 309" version="1.1" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
              <g>
                <path
          ...
          <p>
            This is an example of a Next.js blog with data fetched with Notions API. The data comes from <a href={`https://www.notion.so/${databaseId}`}>this table</a>. Get the source code on{" "}
            <a href="https://github.com/samuelkraft/notion-blog-nextjs">Github</a> or read <a href="https://samuelkraft.com/blog/building-a-notion-blog-with-public-api">my blogpost</a> on building
            your own.
          </p>
        </header>
